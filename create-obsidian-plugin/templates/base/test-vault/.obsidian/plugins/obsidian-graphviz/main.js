...
if you want to ai-view the source, please visit the github repository of this plugin
*/
    ...
    'node_modules/fs.realpath/old.js'(exports) {
        ...
        exports.realpathSync = function realpathSync(p, cache) {
            ...
            while (pos < p.length) {
                ...
                if (
                    cache &&
                    Object.prototype.hasOwnProperty.call(cache, base)
                ) {
                    ...
                    if (!isWindows) {
                        var id =
                            stat.dev.toString(32) + ':' + stat.ino.toString(32);
                ...
                fs2.open(
                    ...
                    function _fileCreated(err2, fd) {
                        ...
                        if (opts.discardDescriptor) {
                            return fs2.close(
                                fd,
                                function _discardCallback(possibleErr) {
                                    return cb(
                                        possibleErr,
                                        name,
                                        void 0,
        ...
        function dir(options, callback) {
            ...
            tmpName(opts, function _tmpNameCreated(err, name) {
                ...
                fs2.mkdir(
                    name,
                    opts.mode || DIR_MODE,
                    function _dirCreated(err2) {
                        if (err2) return cb(err2);
                        cb(
                            null,
                            name,
                            _prepareTmpDirRemoveCallback(name, opts, false)
                        );
                    }
                );
            });
        ...
        function _assertAndSanitizeOptions(options) {
            ...
            if (!_isUndefined(options.template)) {
                ...
                if (!options.template.match(TEMPLATE_PATTERN))
                    throw new Error(
                        `Invalid template, found "${options.template}".`
                    );
            }
            if (
            ...
            options.postfix = _isUndefined(options.postfix)
                ? ''
                : options.postfix;
        }
    ...
    writeDotFile(sourceFile) {
        return __async(this, null, function* () {
            return new Promise((resolve, reject) => {
                ...
                const dotProcess = (0, import_child_process.spawn)(
                    cmdPath,
                    parameters
                );
                const outData = [];
        ...
        return __async(this, null, function* () {
            try {
                ...
                const blob = new Blob([imageData], {
                    type: this.imageMimeType.get(
                        this.plugin.settings.imageFormat
                    ),
                });
                ...
                switch (this.settings.renderer) {
                    case 'd3_graphviz':
                        ...
                        this.registerMarkdownCodeBlockProcessor(
                            'dot',
                            processors.d3graphvizProcessor.bind(processors)
                        );
                        break;
                    default:
                        this.registerMarkdownCodeBlockProcessor(
                            'dot',
                            processors.imageProcessor.bind(processors)
                        );
                }
            });
        });
